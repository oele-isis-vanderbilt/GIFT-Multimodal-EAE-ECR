...
from .clip.make_model import make_model
from .hacnn import HACNN
from .lmbn.lmbn_n import LMBN_n
from .mlfn import mlfn
from .mobilenetv2 import (mobilenetv2_x1_0,
                                                     mobilenetv2_x1_4)
from .osnet import (osnet_ibn_x1_0, osnet_x0_5,
                                               osnet_x0_25, osnet_x0_75,
                                               osnet_x1_0)
from .osnet_ain import (osnet_ain_x0_5,
                                                   osnet_ain_x0_25,
                                                   osnet_ain_x0_75,
                                                   osnet_ain_x1_0)
...
def build_model(name, num_classes, loss="softmax", pretrained=True, use_gpu=True):
    ...
    if 'clip' in name:
        from Track.appearance.backbones.clip.config.defaults import _C as cfg
